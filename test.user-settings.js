...
import Component, { meta } from "./test.md";
import { render } from "@testing-library/react";

describe("jest transformer md", () => {
  test("that meta is correct", () => {
    expect(meta.title).toBe("Jest Transformer MD");
    expect(meta.path).toBe("https://soulpicks.com");
    expect(meta.from).toBe("Batman");
    expect(meta.location).toBe("Amsterdam");
  });
